...
description: "Cosmic Python Part 1 - 트랜잭션 관리와 일관성 경계를 다루는 Unit of Work, Aggregate 패턴을 알아보자"
...
> 이전 글: [제1부(2): Service Layer와 TDD 전략](https://crescentfull.github.io/posts/part1-ch4/)
>
> 다음: [제2부: 이벤트 기반 아키텍처(Event-Driven Architecture)](https://crescentfull.github.io/posts/part2/)에서 이어진다.
