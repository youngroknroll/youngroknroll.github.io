---
title: "제1부(1): 도메인 모델링, Repository 패턴, 그리고 추상화"
description: "Cosmic Python Part 1 - 도메인 모델을 중심에 두고, 결합도를 낮추는 추상화와 함께 인프라로부터 비즈니스 로직을 분리하는 아키텍처의 기초를 알아보자"
...
> 다음 글: [제1부(2): Service Layer와 TDD 전략](https://crescentfull.github.io/posts/part1-ch4/)에서 이어진다.
